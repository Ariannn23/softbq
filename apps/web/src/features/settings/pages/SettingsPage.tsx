        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                type="text"
                value={settings["min_version_required"] || "0.0.0"}
                onChange={(e) => handleChange("min_version_required", e.target.value)}
                className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="0.1.0"
              />
              <p className="text-xs text-slate-500 mt-1">Obliga a los usuarios a actualizar (ej. 0.1.2)</p>
            </div>
          </div>
        </div>
